...
const SectionD2 = ({ checkboxChange }) => (
  <>
    <QuestionContainer>
      ...
      <QuestionCard>
        ...
        <Checkbox type="checkbox" id={data[20].questionNumber} onChange={checkboxChange} />
      ...
      <QuestionCard height="22rem">
        ...
        <Checkbox type="checkbox" id={data[21].questionNumber} onChange={checkboxChange} />
      ...
      <QuestionCard>
        ...
        <Checkbox type="checkbox" id={data[22].questionNumber} onChange={checkboxChange} />
      ...
      <QuestionCard>
        ...
        <Checkbox type="checkbox" id={data[23].questionNumber} onChange={checkboxChange} />
      ...
      <QuestionCard>
        ...
        <Checkbox type="checkbox" id={data[24].questionNumber} onChange={checkboxChange} />
